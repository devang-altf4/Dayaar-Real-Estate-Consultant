    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-3.5 py-2 bg-white hover:bg-slate-50 text-slate-700 text-xs font-bold rounded-xl border border-slate-300 transition-all shadow-xs disabled:opacity-50 self-start sm:self-auto"
        >
                  ...
                  <tr key={call._id} className="hover:bg-slate-50/70 transition-colors">
                    ...
                    <td className="p-4">
                      {(isAdmin || isManager) && call.recordingStatus === RecordingStatus.ARCHIVED ? (
                        ...
                        <span className="inline-flex items-center gap-1 text-[11px] font-semibold text-amber-700 bg-amber-50 px-2 py-1 rounded-lg border border-amber-200 animate-pulse">
                          ⏳ Syncing Audio...
                        </span>
                      ) : (isAdmin || isManager) && call.recordingStatus === RecordingStatus.FAILED ? (
                        <span className="text-[11px] text-rose-500 font-semibold">Recording Failed</span>
                      ) : (
